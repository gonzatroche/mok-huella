...
-- =====================================================================
-- MÓDULO CBAM (anexado — ver migrations/002_cbam.sql)
-- =====================================================================
...
-- =====================================================================
-- MEJORAS ISO 14064-1 (anexado — ver migrations/003_mejoras_norma.sql)
-- =====================================================================
-- ---------------------------------------------------------------------
...
-- =====================================================================
-- SEED Fase 0 — Catálogo mínimo de factores de emisión + fuentes (Uruguay)
-- (idéntico a supabase/migrations/004_seed_factores_uy.sql)
--
-- ⚠️  VALORES DE REFERENCIA — VALIDAR contra la fuente oficial que adopte la
--     organización (MIEM/Observatorio, Inventario Nacional de GEI, IPCC, DEFRA)
--     antes del reporte final. La electricidad de red UY es volátil año a año:
--     reemplazar 0,066 kg CO2e/kWh por el valor anual oficial del MIEM.
--     La leña es CO2 biogénico (se reporta aparte); el factor cubre solo CH4+N2O.
-- =====================================================================
